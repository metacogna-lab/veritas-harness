...
- Add specialists + tool allowlist in `harness/veritas-research/src/agent/specialists.ts` or a new loadout module
- Register a target adapter for the domain scope model
- Register in `harness/veritas-research/src/agent/loadouts.ts`
